...
# =========================================================
# Formatare numerică și etichetare coloane
# =========================================================
def fmt_numeric(val, col_name: str = "") -> str:
    """Formatează valorile numerice (cu sau fără zecimale, separator mii, etc.)"""
    if val is None:
        return ""
    raw = str(val).strip()
    if raw == "":
...
def col_label(col: str, table: str = None) -> str:
    """Returnează eticheta vizuală pentru o coloană, în funcție de tabelă."""
...
# =========================================================
# Funcții de conversie date (deja în date_helpers.py, dar le re-exportăm pentru comoditate)
# =========================================================
from utils.date_helpers import to_date, calc_durata, add_months, sub_months

# =========================================================
# Funcții de interogare date (re-export din supabase_helpers)
# =========================================================
from utils.supabase_helpers import safe_select_eq

# =========================================================
# Helper pentru determinarea câmpurilor vizibile și ordonate
# =========================================================
def get_visible_ordered_fields(row: dict, table: str, tabela_baza_ctx: str = None) -> list:
    """
    Returnează lista câmpurilor vizibile (neascunse, ne-goale) în ordinea corectă
    pentru o secțiune (Generale, Financiar, Tehnic).
    """
...
# =========================================================
# Funcții pentru obținerea informațiilor de contact (echipă)
# =========================================================
def get_contact_info(supabase, nume: str) -> list:
    """Returnează lista de stringuri cu departament, email, telefon pentru o persoană."""
...
def is_persoana_contact(r: dict) -> bool:
    """Determină dacă un rând din com_echipe_proiect marchează persoana de contact."""
