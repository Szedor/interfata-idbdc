# =========================================================
# utils/export_pdf.py
# v.modul.2.1 - Revenire la reportlab cu font standard pentru diacritice
# =========================================================
...
def _register_font():
    ...
    # Lista de fonturi disponibile în diverse sisteme
    font_paths = [
        # Linux / Docker
    ...
    # Fallback - Helvetica (fără diacritice, dar nu crapă)
    return "Helvetica"
...
def generate_pdf_vertical(supabase, cod: str, tabela_gasita: str, titlu_fisa: str, build_vertical_export_data_func) -> bytes:
    ...
    Folosește reportlab cu font care suportă diacritice (dacă există pe sistem).
    """
    try:
