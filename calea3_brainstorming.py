...
UPT_EMAIL_REGEX = re.compile(r"^[a-z]+(?:.[a-z]+)[+@upt.ro](mailto:+@upt.ro)$", re.IGNORECASE)
...
def render_header():
st.markdown(
f""" <div class="idbdc-header"> <div class="idbdc-title-1">{TITLE_LINE_1}</div> <div class="idbdc-title-2">{TITLE_LINE_2}</div> </div>
""",
unsafe_allow_html=True,
)
