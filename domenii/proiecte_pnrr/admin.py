...
from domenii.proiecte_pnrr.definitie           import TIP_LABEL, BASE_TABLE
from domenii._baza.sectiune_baza_proiecte_pnrr import render as _baza_render_baza
from domenii._baza.sectiune_financiar_pnrr     import render as _baza_render_financiar
