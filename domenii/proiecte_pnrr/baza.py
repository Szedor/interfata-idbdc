# =========================================================
# IDBDC/domenii/proiecte_pnrr/baza.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.06.02
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "DOMENIUL":               date_existente.get("domeniu_cercetare", "") or "",
        "📅 DATA DE INCEPUT":     di,
        "📅 DATA DE SFARSIT":     ds,
        ...
        "PILONUL":                date_existente.get("pilonul", "") or "",
        "COMPONENTA":             date_existente.get("componenta", "") or "",
        "INVESTITIA":             date_existente.get("investitia", "") or "",
        "SUBINVESTITIA":          date_existente.get("subinvestitia", "") or "",
    ...
    col_cfg = {
        ...
        "INVESTITIA":             st.column_config.TextColumn("INVESTITIA"),
        "SUBINVESTITIA":          st.column_config.TextColumn("SUBINVESTITIA"),
    ...
    return {
        ...
        "domeniu_cercetare":       _str(row["DOMENIUL"]),
        ...
        "pilonul":                 _str(row["PILONUL"]),
        "componenta":              _str(row["COMPONENTA"]),
        "investitia":              _str(row["INVESTITIA"]),
        "subinvestitia":           _str(row["SUBINVESTITIA"]),
