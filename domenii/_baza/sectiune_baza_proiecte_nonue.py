# =========================================================
# IDBDC/domenii/_baza/sectiune_baza_proiecte_nonue.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.05.23
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    if di and ds and not dur_ex: dur_ex = calc_durata(di, ds)
    ...
    row_init = {
        ...
        "SURSA DE FINANTARE":           date_existente.get("sursa_finantatoare", ""),
        "LINIA DE FINANTARE":           date_existente.get("categoria", ""),
        "DOMENIUL TEMATIC":             date_existente.get("tematica", ""),
        "TIPUL DE OPERATIUNE":          date_existente.get("operatiunea", ""),
        "MECANISMUL FINANCIAR":         date_existente.get("mecanism_financiar", ""),
        "INSTRUMENTUL DE IMPLEMENTARE": date_existente.get("instrument_implementare", ""),
    ...
    di_e = row["DATA DE INCEPUT"]; ds_e = row["DATA DE SFARSIT"]
    ...
    return {
        ...
        "sursa_finantatoare":      _s(row["SURSA DE FINANTARE"]),
        "categoria":               _s(row["LINIA DE FINANTARE"]),
        "tematica":                _s(row["DOMENIUL TEMATIC"]),
        "operatiunea":             _s(row["TIPUL DE OPERATIUNE"]),
        "mecanism_financiar":      _s(row["MECANISMUL FINANCIAR"]),
        "instrument_implementare": _s(row["INSTRUMENTUL DE IMPLEMENTARE"]),
