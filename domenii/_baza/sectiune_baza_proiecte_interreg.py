# =========================================================
# IDBDC/domenii/_baza/sectiune_baza_proiecte_interreg.py
# VERSIUNE: 1.1
# STATUS: ACTUALIZAT - OBIECTIVUL in loc de OBIECTIV SPECIFIC
# DATA: 2026.05.09
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "PRIORITATEA PROGRAMULUI":date_existente.get("prioritatea_programului", ""),
    ...
    col_cfg = {
        ...
        "PRIORITATEA PROGRAMULUI":st.column_config.TextColumn("PRIORITATEA PROGRAMULUI"),
    ...
    return {
        ...
        "prioritatea_programului":_s(row["PRIORITATEA PROGRAMULUI"]),
