...
# VERSIUNE: 1.0
# STATUS: NOU - Date de bază pentru Proiecte INTERREG
# DATA: 2026.05.09
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "OBIECTIV SPECIFIC":          date_existente.get("obiectiv_specific", ""),
    ...
    col_cfg = {
        ...
        "OBIECTIV SPECIFIC":      st.column_config.TextColumn("OBIECTIV SPECIFIC", width="large"),
    ...
    return {
        ...
        "obiectiv_specific":       _s(row["OBIECTIV SPECIFIC"]),
