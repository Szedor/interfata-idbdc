# =========================================================
# IDBDC/domenii/_baza/sectiune_tehnic.py
# VERSIUNE: 1.0
# STATUS: NOU - Aspecte tehnice comune pentru toate proiectele
# DATA: 2026.05.09
# =========================================================
# CONȚINUT:
#   Randează secțiunea Aspecte tehnice pentru orice tip
#   de proiect. Conținut preluat din
#   utils/sectiuni/aspecte_tehnice.py v1.0, neatins.
# =========================================================
...
def render(supabase, cod_introdus, is_new, date_existente):
    ...
    col_cfg = {
        ...
        "ACTIVITATI":          st.column_config.TextColumn("⚙️ ACTIVITATI",          width="large"),
