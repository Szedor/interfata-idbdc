# =========================================================
# IDBDC/domenii/_baza/sectiune_baza_proiecte_pnrr.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.05.23
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "DOMENIUL":              date_existente.get("domeniu_cercetare", ""),
        "DATA DE INCEPUT":       di,
        "DATA DE SFARSIT":       ds,
        ...
        "PILONUL":               date_existente.get("pilonul", ""),
        "COMPONENTA":            date_existente.get("componenta", ""),
        "INVESTITIA":            date_existente.get("investitia", ""),
        "SUBINVESTITIA":         date_existente.get("subinvestitia", ""),
    ...
    col_cfg = {
        ...
        "PILONUL":               st.column_config.TextColumn("PILONUL"),
        "COMPONENTA":            st.column_config.TextColumn("COMPONENTA"),
        "INVESTITIA":            st.column_config.TextColumn("INVESTITIA", width="large"),
        "SUBINVESTITIA":         st.column_config.TextColumn("SUBINVESTITIA", width="large"),
    ...
    return {
        ...
        "domeniu_cercetare":       _s(row["DOMENIUL"]),
        ...
        "pilonul":                 _s(row["PILONUL"]),
        "componenta":              _s(row["COMPONENTA"]),
        "investitia":              _s(row["INVESTITIA"]),
        "subinvestitia":           _s(row["SUBINVESTITIA"]),
