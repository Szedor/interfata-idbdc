# =========================================================
# domenii/_baza/sectiune_echipa.py
...
def render(supabase, cod_introdus, is_new, date_existente):
    ...
    for idx, row in df_edit.iterrows():
        ...
        if idx < len(st.session_state[key_rows]):
            ...
            if nume:
                info = info_map.get(nume, {})
                st.session_state[key_rows][idx]["departament"] = info.get("departament", "")
                st.session_state[key_rows][idx]["email"] = info.get("email", "")
                st.session_state[key_rows][idx]["mobil"] = info.get("mobil", "")
                ...
                st.session_state[key_rows][idx]["mobil"] = ""
