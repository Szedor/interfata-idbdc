...
from domenii.contracte_terti.baza      import render as _render_baza
from domenii.contracte_terti.financiar import render as _render_financiar
from domenii._baza.echipa              import render as _render_echipa
from domenii.contracte_terti.definitie import TIP_LABEL, CAT_LABEL, BASE_TABLE
