# =========================================================
# IDBDC/domenii/proiecte_structurale/baza.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.06.02
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "PROGRAMUL OPERATIONAL":  date_existente.get("programul", "") or "",
        "AXA SPECIFICA":          date_existente.get("axa_specifica", "") or "",
        "PRIORITATEA":            date_existente.get("prioritatea", "") or "",
        "OBIECTIVUL":             date_existente.get("obiectivul", "") or "",
    ...
    col_cfg = {
        ...
        "PRIORITATEA":            st.column_config.TextColumn("PRIORITATEA"),
    ...
    return {
        ...
        "programul":               _str(row["PROGRAMUL OPERATIONAL"]),
        "axa_specifica":           _str(row["AXA SPECIFICA"]),
        "prioritatea":             _str(row["PRIORITATEA"]),
        "obiectivul":              _str(row["OBIECTIVUL"]),
