# =========================================================
# IDBDC/domenii/proiecte_structurale/admin.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.05.23
# =========================================================

from domenii.proiecte_structurale.definitie           import TIP_LABEL, BASE_TABLE
from domenii._baza.sectiune_baza_proiecte_structurale import render as _baza_render_baza
from domenii._baza.sectiune_financiar_structurale     import render as _baza_render_financiar
...
def render_date_de_baza(supabase, cod_introdus, cat_sel, tip_sel, is_new, date_baza_ex):
    return _baza_render_baza(supabase=supabase, cod_introdus=cod_introdus, cat_sel=cat_sel,
