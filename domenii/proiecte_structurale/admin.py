...
from domenii.proiecte_structurale.baza      import render as _render_baza
from domenii.proiecte_structurale.financiar import render as _render_financiar
from domenii.proiecte_structurale.tehnic    import render as _render_tehnic
from domenii._baza.echipa                   import render as _render_echipa
from domenii.proiecte_structurale.definitie import TIP_LABEL, CAT_LABEL, BASE_TABLE
