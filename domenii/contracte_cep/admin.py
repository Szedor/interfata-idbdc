...
from domenii.contracte_cep.baza      import render as _render_baza
from domenii.contracte_cep.financiar import render as _render_financiar
from domenii._baza.echipa            import render as _render_echipa
from domenii.contracte_cep.definitie import TIP_LABEL, CAT_LABEL, BASE_TABLE
