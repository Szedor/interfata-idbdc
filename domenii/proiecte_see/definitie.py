...
# VERSIUNE: 1.1
# STATUS: ACTUALIZAT - financiar completat conform mapare finala
# DATA: 2026.05.23
# =========================================================
...
COL_LABELS = {
    ...
    "valuta":                    "VALUTA",
    "costuri_totale_proiect":    "CHELTUIELI ELIGIBILE TOTALE",
    "buget_upt":                 "BUGET UPT",
    "contributie_finantator":    "CONTRIBUTIE MECANISM",
...
COL_ORDER_GENERALE = [
    ...
    "data_inchidere_apel", "mecanism_finantare", "program_finantare",
    "sector_prioritar_specific", "domeniul", "website",
]
COL_ORDER_FINANCIAR = [
    "cod_identificare", "valuta", "costuri_totale_proiect",
    "buget_upt", "contributie_finantator",
    "cofinantare_nationala", "cofinantare_upt",
]
