# =========================================================
# IDBDC/domenii/proiecte_see/baza.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.06.02
# =========================================================
...
# 15. MECANISM DE FINANTARE
# 16. PROGRAMUL DE FINANTARE
# 17. SECTOR PRIORITAR SPECIFIC
# 18. DOMENIUL
# 19. WEBSITE
# 20. OBSERVATII
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "MECANISM DE FINANTARE":    date_existente.get("mecanism_finantare", "") or "",
        "PROGRAMUL DE FINANTARE":   date_existente.get("program_finantare", "") or "",
        "SECTOR PRIORITAR SPECIFIC":date_existente.get("sector_prioritar_specific", "") or "",
        "DOMENIUL":                 date_existente.get("domeniul", "") or "",
    ...
    return {
        ...
        "mecanism_finantare":       _str(row["MECANISM DE FINANTARE"]),
        "program_finantare":        _str(row["PROGRAMUL DE FINANTARE"]),
        "sector_prioritar_specific":_str(row["SECTOR PRIORITAR SPECIFIC"]),
        "domeniul":                 _str(row["DOMENIUL"]),
