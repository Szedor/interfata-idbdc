...
from domenii.proiecte_pncdi.baza      import render as _render_baza
from domenii.proiecte_pncdi.financiar import render as _render_financiar
from domenii.proiecte_pncdi.tehnic    import render as _render_tehnic
from domenii._baza.echipa             import render as _render_echipa
from domenii.proiecte_pncdi.definitie import TIP_LABEL, CAT_LABEL, BASE_TABLE
