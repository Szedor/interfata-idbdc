# =========================================================
# IDBDC/domenii/proiecte_pncdi/admin.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.05.23
# =========================================================

from domenii.proiecte_pncdi.definitie            import TIP_LABEL, BASE_TABLE
from domenii._baza.sectiune_baza_proiecte_pncdi  import render as _baza_render_baza
from domenii._baza.sectiune_financiar_pncdi      import render as _baza_render_financiar
