...
from domenii.contracte_speciale.baza      import render as _render_baza
from domenii.contracte_speciale.financiar import render as _render_financiar
from domenii._baza.echipa                 import render as _render_echipa
from domenii.contracte_speciale.definitie import TIP_LABEL, CAT_LABEL, BASE_TABLE
