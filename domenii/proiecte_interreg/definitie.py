...
# VERSIUNE: 1.1
# STATUS: ACTUALIZAT - OBIECTIVUL; financiar actualizat
# DATA: 2026.05.09
# =========================================================
...
COL_ORDER_GENERALE = [
    ...
    "data_inchidere_apel", "program_finantare", "prioritatea_programului",
    "obiectivul", "website",
]
COL_ORDER_FINANCIAR = [
    "cod_identificare", "valuta", "costuri_totale_proiect", "buget_upt",
