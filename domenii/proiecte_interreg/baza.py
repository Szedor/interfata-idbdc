# =========================================================
# IDBDC/domenii/proiecte_interreg/baza.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.06.01
# =========================================================
...
# 15. PROGRAM DE FINANTARE
# 16. PRIORITATEA PROGRAMULUI
# 17. OBIECTIVUL
# 18. WEBSITE
# 19. OBSERVATII
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "PRIORITATEA PROGRAMULUI":  date_existente.get("prioritatea_programului", "") or "",
    ...
    col_cfg = {
        ...
        "PRIORITATEA PROGRAMULUI": st.column_config.TextColumn("PRIORITATEA PROGRAMULUI", width="large"),
    ...
    return {
        ...
        "prioritatea_programului": _str(row["PRIORITATEA PROGRAMULUI"]),
