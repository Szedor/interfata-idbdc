...
def render_suplimentare(supabase, cod_introdus, is_new, date_existente):
    ...
    with r3_c2:
        text_epo = date_existente.get("titlu_engleza_epo", "") or date_existente.get("titlu_engleza_fisa_inventiei", "") or ""
        st.text_input("TITLU ENGLEZA EPO", value=text_epo, key=f"pi_epo_{cod_introdus}")
    ...
    with r4_c2:
        text_fisa = date_existente.get("titlu_engleza_fisa_inventiei", "") or date_existente.get("titlu_engleza_epo", "") or ""
        st.text_input("TITLU ENGLEZA FISA INVENTIEI", value=text_fisa, key=f"pi_fisa_{cod_introdus}")
    ...
    return {
        ...
        "titlu_engleza_epo": _str(text_epo),
        "titlu_engleza_fisa_inventiei": _str(text_fisa),
