# =========================================================
# IDBDC/domenii/proiecte_nonue/baza.py
# VERSIUNE: 1.0
# STATUS: NOU
# DATA: 2026.06.02
# =========================================================
...
#  9. STATUS PROIECT                   ← 🔖
# 10. NR.PARTICIPANTI
# 11. DENUMIRE PARTICIPANTI
# 12. ROL UPT                          ← 🔖
# 13. APELUL
# 14. DATA LIMITA DEPUNERE             ← 📅
# 15. SURSA DE FINANTARE
# 16. LINIA DE FINANTARE
# 17. DOMENIUL TEMATIC
# 18. TIPUL DE OPERATIUNE
# 19. MECANISMUL FINANCIAR
# 20. INSTRUMENTUL DE IMPLEMENTARE
# 21. WEBSITE
# 22. OBSERVATII
# =========================================================
...
def render(supabase, cod_introdus, cat_sel, tip_label, tabela_nume, is_new, date_existente):
    ...
    row_init = {
        ...
        "SURSA DE FINANTARE":            date_existente.get("sursa_finantatoare", "") or "",
        "LINIA DE FINANTARE":            date_existente.get("categoria", "") or "",
        "DOMENIUL TEMATIC":              date_existente.get("tematica", "") or "",
        "TIPUL DE OPERATIUNE":           date_existente.get("operatiunea", "") or "",
        "MECANISMUL FINANCIAR":          date_existente.get("mecanism_financiar", "") or "",
        "INSTRUMENTUL DE IMPLEMENTARE":  date_existente.get("instrument_implementare", "") or "",
    ...
    col_cfg = {
        ...
        "SURSA DE FINANTARE":           st.column_config.TextColumn("SURSA DE FINANTARE"),
        "LINIA DE FINANTARE":           st.column_config.TextColumn("LINIA DE FINANTARE"),
        "DOMENIUL TEMATIC":             st.column_config.TextColumn("DOMENIUL TEMATIC", width="large"),
        "TIPUL DE OPERATIUNE":          st.column_config.TextColumn("TIPUL DE OPERATIUNE"),
        "MECANISMUL FINANCIAR":         st.column_config.TextColumn("MECANISMUL FINANCIAR"),
        "INSTRUMENTUL DE IMPLEMENTARE": st.column_config.TextColumn("INSTRUMENTUL DE IMPLEMENTARE"),
    ...
    return {
        ...
        "sursa_finantatoare":       _str(row["SURSA DE FINANTARE"]),
        "categoria":                _str(row["LINIA DE FINANTARE"]),
        "tematica":                 _str(row["DOMENIUL TEMATIC"]),
        "operatiunea":              _str(row["TIPUL DE OPERATIUNE"]),
        "mecanism_financiar":       _str(row["MECANISMUL FINANCIAR"]),
        "instrument_implementare":  _str(row["INSTRUMENTUL DE IMPLEMENTARE"]),
