...
# =========================================================
# admin/fise/proiecte_internationale.py
# VERSIUNE: 1.0
# STATUS: STABIL - Fațadă Admin pentru Proiecte INTERNATIONALE
# DATA: 2026.05.05
# =========================================================
# CONȚINUT:
#   Fațadă pentru Calea2 (Admin) — expune cele 4 metode
#   de randare/colectare date pentru proiectele INTERNATIONALE:
...
#
#   Pattern identic cu proiecte_fdi.py — doar tip_label și
#   tabela_nume diferite.
#
...
def render_date_de_baza(supabase, cod_introdus, cat_sel, tip_sel, is_new, date_baza_ex):
    return _render_baza(
        ...
        tabela_nume="base_proiecte_internationale",
        is_new=is_new,
