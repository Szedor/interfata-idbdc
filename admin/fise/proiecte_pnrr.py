...
# =========================================================
# admin/fise/proiecte_pnrr.py
# VERSIUNE: 1.0
# STATUS: STABIL - Fațadă Admin pentru Proiecte PNRR
# DATA: 2026.05.05
# =========================================================
# CONȚINUT:
#   Fațadă pentru Calea2 (Admin) — expune cele 4 metode
#   pentru proiectele PNRR. Date financiare folosesc modulul
#   specific PNRR (placeholder — ajustați coloanele după BD).
#
...
from utils.sectiuni.date_financiare_pnrr import render_date_financiare_pnrr as _render_fin
...
def render_date_de_baza(supabase, cod_introdus, cat_sel, tip_sel, is_new, date_baza_ex):
    return _render_baza(
        ...
        cat_sel=cat_sel,
        tip_label="PNRR",
        tabela_nume="base_proiecte_pnrr",
        is_new=is_new,
